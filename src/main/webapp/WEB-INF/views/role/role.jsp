			...
			<div class="table-responsive">
				<div id="sample-table-2_wrapper" class="dataTables_wrapper"
					...
					<div class="row">
						<div class="col-sm-6">
							<div>
								<button type="button" class="btn btn-info btn-sm" id="add_btn">添加角色</button>
							</div>
						</div>
						<div class="col-sm-4  no-padding-right">
							<div class="dataTables_filter"> 
								<input name="roleName" class="filter" type="text">
							</div>
						</div>
...
<jsp:include page="role_view.jsp"></jsp:include>
<jsp:include page="../../common/js.jsp"></jsp:include>
<script type="text/javascript" src="${contextPath }/static/modules/role.js"></script>
</body>
</html>