			...
			<div class="table-responsive">
				<div id="sample-table-2_wrapper" class="dataTables_wrapper"
					...
					<div class="row">
						<div class="col-sm-6">
							<div>
								<button type="button" class="btn btn-info btn-sm" id="add_btn">添加部门表</button>
							</div>
						</div>
			...
			<div class="modal-body">
				<form class="form-horizontal tasi-form" method="get" id="edit_form">
					<input type="hidden" name="id">
							...
							<div class="col-sm-9">
								<input type="text"  placeholder="请输入部门名称" name="deptName"
									class="form-control col-xs-10 col-sm-12">
							</div>
						</div>
						<div class="form-group">
					  		<label class="col-sm-3 control-label no-padding-right"> 部门信息 </label>
							<div class="col-sm-9">
								<input type="text"  placeholder="请输入部门信息" name="deptInfo"
									class="form-control col-xs-10 col-sm-12">
							</div>
						</div>
						<div class="form-group">
					  		<label class="col-sm-3 control-label no-padding-right"> 部门编号 </label>
							<div class="col-sm-9">
								<input type="text"  placeholder="请输入部门编号" name="deptCode"
									class="form-control col-xs-10 col-sm-12">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text"  placeholder="请输入创建时间" name="createTime"
									class="form-control col-xs-10 col-sm-12">
							</div>
						</div>
...
<script type="text/javascript" src="${contextPath }/static/modules/department.js"></script>
</body>
</html>
