...
<body>
	...
	<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">会议列表</h3>
			...
			<div class="table-responsive">
				<div id="sample-table-2_wrapper" class="dataTables_wrapper"
					...
					<div class="row">
						<div class="col-sm-6">
							<div>
								<button type="button" class="btn btn-info btn-sm" id="add_btn">添加会议</button>
							</div>
						</div>
...
<jsp:include page="meeting_add.jsp"></jsp:include>
<jsp:include page="meeting_edit.jsp"></jsp:include>
<jsp:include page="meeting_view.jsp"></jsp:include>
<jsp:include page="../../common/js.jsp"></jsp:include>
<script type="text/javascript" src="${contextPath }/static/modules/meeting.js"></script>
</body>
</html>