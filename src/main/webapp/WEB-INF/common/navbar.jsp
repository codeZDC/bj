			...
			<ul class="nav ace-nav">
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img src="${contextPath}/static/ace/avatars/avatar.png"
						...
						<li><a href="#"> <img src="${contextPath}/static/ace/avatars/avatar3.png"
						...
						<li><a href="#"> <img src="${contextPath}/static/ace/avatars/avatar4.png"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${contextPath}/static/ace/avatars/user.jpg" alt="Jason's Photo" /> <span
