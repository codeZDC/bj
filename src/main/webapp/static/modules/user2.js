...
function buildTable(){
	...
	$.each(localData,function(ind){
		...
		age = $('<td>').text(this.age);
		job = $('<td>').text(this.job);

		$('<tr>').attr('id',this.id).append(index).append(name).append(age).append(job)
